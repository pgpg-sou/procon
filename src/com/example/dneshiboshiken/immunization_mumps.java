...
public class immunization_mumps extends Activity {

	private String setpath = "immunization_mumps";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_mumps_ymd1,
			R.id.TextView_immunization_write_mumps_ymd2,
			R.id.TextView_immunization_write_mumps_lot1,
			R.id.TextView_immunization_write_mumps_lot2,
			R.id.TextView_immunization_write_mumps_name1,
			R.id.TextView_immunization_write_mumps_name2,
			R.id.TextView_immunization_write_mumps_other1,
			R.id.TextView_immunization_write_mumps_other2,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_mumps);
    }
