...
public class immunization_mr extends Activity {

	private String setpath = "immunization_mr";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_mr_ymd1,
		R.id.TextView_immunization_write_mr_ymd2,
		R.id.TextView_immunization_write_mr_lot1,
		R.id.TextView_immunization_write_mr_lot2,
		R.id.TextView_immunization_write_mr_name1,
		R.id.TextView_immunization_write_mr_name2,
		R.id.TextView_immunization_write_mr_other1,
		R.id.TextView_immunization_write_mr_other2,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_mr);
    }
    ...
    public void onStart(){
        ...
        button_Write_child_9_12_1_next.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
            	Intent intent_read_1 = new Intent(getApplicationContext(),immunization_japan.class);
                startActivity(intent_read_1);
                finish();
            }
        });
