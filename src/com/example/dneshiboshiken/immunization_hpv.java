...
public class immunization_hpv extends Activity {

	private String setpath = "immunization_hpv";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_hpv_ymd1,
		R.id.TextView_immunization_write_hpv_ymd2,
		R.id.TextView_immunization_write_hpv_ymd3,
		R.id.TextView_immunization_write_hpv_lot1,
		R.id.TextView_immunization_write_hpv_lot2,
		R.id.TextView_immunization_write_hpv_lot3,
		R.id.TextView_immunization_write_hpv_name1,
		R.id.TextView_immunization_write_hpv_name2,
		R.id.TextView_immunization_write_hpv_name3,
		R.id.TextView_immunization_write_hpv_other1,
		R.id.TextView_immunization_write_hpv_other2,
		R.id.TextView_immunization_write_hpv_other3,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_hpv);
    }
    ...
    public void onStart(){
        ...
        button_Write_child_9_12_1_next.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
            	Intent intent_read_1 = new Intent(getApplicationContext(),immunization_varicella.class);
                startActivity(intent_read_1);
                finish();
            }
        });
