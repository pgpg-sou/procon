...
public class write_condition_1 extends Activity {
	//目次の項目だけボタンを定義
	...
	public static int[] item_checkup_8 = {R.id.EditText_write_condition_day_record,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.write_condition_1);	//画面レイアウトを指定(res/layout/index_read.xml)
...
private void button_Write_child_9_12_1_home_onClick() {
	Intent intent_read_2 = new Intent(getApplicationContext(),write_condition_1p.class);
