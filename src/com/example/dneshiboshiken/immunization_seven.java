...
public class immunization_seven extends Activity {

	private String setpath = "immunization_seven";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_seven_ymd1,
		R.id.TextView_immunization_write_seven_ymd2,
		R.id.TextView_immunization_write_seven_ymd3,
		R.id.TextView_immunization_write_seven_ymd4,
		R.id.TextView_immunization_write_seven_lot1,
		R.id.TextView_immunization_write_seven_lot2,
		R.id.TextView_immunization_write_seven_lot3,
		R.id.TextView_immunization_write_seven_lot4,
		R.id.TextView_immunization_write_seven_name1,
		R.id.TextView_immunization_write_seven_name2,
		R.id.TextView_immunization_write_seven_name3,
		R.id.TextView_immunization_write_seven_name4,
		R.id.TextView_immunization_write_seven_other1,
		R.id.TextView_immunization_write_seven_other2,
		R.id.TextView_immunization_write_seven_other3,
		R.id.TextView_immunization_write_seven_other4,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_seven);
    }
    ...
    public void onStart(){
        ...
        button_Write_child_9_12_1_back.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
            	//mode="aaaa";
            	Intent intent_read_1 = new Intent(getApplicationContext(),immunization_hib.class);
        ...
        button_Write_child_9_12_1_next.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
            	Intent intent_read_1 = new Intent(getApplicationContext(),immunization_hpv.class);
                startActivity(intent_read_1);
                finish();
            }
        });
