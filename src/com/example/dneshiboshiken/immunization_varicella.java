...
public class immunization_varicella extends Activity {

	private String setpath = "immunization_varicella";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_varicella_ymd1,
		R.id.TextView_immunization_write_varicella_ymd2,
		R.id.TextView_immunization_write_varicella_lot1,
		R.id.TextView_immunization_write_varicella_lot2,
		R.id.TextView_immunization_write_varicella_name1,
		R.id.TextView_immunization_write_varicella_name2,
		R.id.TextView_immunization_write_varicella_other1,
		R.id.TextView_immunization_write_varicella_other2,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_varicella);
    }
