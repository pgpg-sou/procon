...
public class immunization_bcg extends Activity {

	private String setpath = "immunization_bcg";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_bcg_ymd1,
		R.id.TextView_immunization_write_bcg_lot1,
		R.id.TextView_immunization_write_bcg_name1,
		R.id.TextView_immunization_write_bcg_other1,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_bcg);
    }
    ...
    public void onStart(){
        ...
        button_Write_child_9_12_1_next.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
            	Intent intent_read_1 = new Intent(getApplicationContext(),immunization_mr.class);
                startActivity(intent_read_1);
                finish();
            }
        });
