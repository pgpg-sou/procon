...
public class immunization_dt extends Activity {

	private String setpath = "immunization_dt";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_dt_ymd1,
		R.id.TextView_immunization_write_dt_lot1,
		R.id.TextView_immunization_write_dt_name1,
		R.id.TextView_immunization_write_dt_other1,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_dt);
    }
