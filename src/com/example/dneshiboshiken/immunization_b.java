...
public class immunization_b extends Activity {

	private String setpath = "immunization_b";
	...
	public static int[] item_immunization_mumps_tag = {R.id.TextView_immunization_write_b_ymd1,
		R.id.TextView_immunization_write_b_ymd2,
		R.id.TextView_immunization_write_b_ymd3,
		R.id.TextView_immunization_write_b_lot1,
		R.id.TextView_immunization_write_b_lot2,
		R.id.TextView_immunization_write_b_lot3,
		R.id.TextView_immunization_write_b_name1,
		R.id.TextView_immunization_write_b_name2,
		R.id.TextView_immunization_write_b_name3,
		R.id.TextView_immunization_write_b_other1,
		R.id.TextView_immunization_write_b_other2,
		R.id.TextView_immunization_write_b_other3,};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.immunization_b);
    }
    ...
    public void onStart(){
        ...
        button_Write_child_9_12_1_back.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
            	//mode="aaaa";
            	Intent intent_read_1 = new Intent(getApplicationContext(),immunization_mumps.class);
        ...
        button_Write_child_9_12_1_next.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
            	Intent intent_read_1 = new Intent(getApplicationContext(),immunization_dpt.class);
                startActivity(intent_read_1);
                finish();
            }
        });
