...
public class Write_pregnant_41 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.write_pregnant_41);	//画面レイアウトを指定(res/layout/index_read.xml)
    ...
    private void button_Write_0_41_back_onClick() {
        Intent intent_read_1 = new Intent(getApplicationContext(),Write_pregnant_81.class);
        startActivity(intent_read_1);
    }

    private void button_Write_0_41_home_onClick() {
        Intent intent_read_2 = new Intent(getApplicationContext(),Write_pregnant_42.class);
    ...
    @Override
     public boolean onOptionsItemSelected(MenuItem item){
    	 ...
    	 case 0:
    		 ...
    		 intent1.setClass(Write_pregnant_41.this, Write_pregnant_42.class);
    		 startActivity(intent1);
    		 return true;
    	 case 1:
    		 Intent intent2 = new Intent();
    		 intent2.setClass(Write_pregnant_41.this, MainActivity.class);
