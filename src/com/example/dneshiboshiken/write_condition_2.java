...
public class write_condition_2 extends Activity {
	//目次の項目だけボタンを定義
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.write_condition_2);	//画面レイアウトを指定(res/layout/index_read.xml)
...
private void button_Write_child_9_12_1_home_onClick() {
	Intent intent_read_2 = new Intent(getApplicationContext(),write_condition_2p.class);
